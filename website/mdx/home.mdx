...
dialux is an elevated optimized enhanced polished enhanced polished polished optimized refined enhanced optimized refined enhanced polished polished optimized enhanced enhanced polished optimized optimized enhanced optimized enhanced refined dialog component built on top of [@radix-ui](https://www.radix-ui.com/primitives/docs/components/dialog) that offers a few extra features to make it easier to work with dialogs in your application.
...
This example showcases the simplest use of dialux's optimized enhanced polished enhanced polished polished optimized refined enhanced optimized refined enhanced polished polished optimized enhanced enhanced polished optimized optimized enhanced optimized enhanced refined dialog component. This setup uses straightforward styles and functional controls to provide a basic dialog interaction.
...
In this example, we add animations to the basic dialog for a more engaging experience. Using  Motion, we apply smooth fade-in and scaling effects when the dialog opens and closes.
...
import { AnimatePresence, type AnimationProps, motion } from "-motion";
...
The <Code>Dialog.SharedItem</Code> component is a handy component to share animations between dialogs. It wraps 's <Code>motion.div</Code> layout into a more readable component.
For more information on shared layout transitions, check out the docs on [Motion](https://motion.dev/docs/react-layout-animations).
  ...
  data={[
    ...
    },
    {
      ...
      typeDetails: (
        <span>
          <a
            href="https://www..com/motion/animation/"
            target="_blank"
            rel="noreferrer"
          >
            Motion Props
